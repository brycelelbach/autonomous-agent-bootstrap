...
| `~/.aab/shell/pi-observability.env` | Pi-only runtime defaults and `NODE_OPTIONS` preloads, including `PI_PATTY_BG_TASKS_DISABLE_CTRL_B=1`. Standard `OTEL_*` variables can override the console exporters. |
