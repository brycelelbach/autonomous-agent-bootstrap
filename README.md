...
| `~/.pi/agent/npm/node_modules/{pi-list-tools,pi-otel}/` | Version-pinned Pi packages for exact tool-registry inspection and structured OpenTelemetry. |
