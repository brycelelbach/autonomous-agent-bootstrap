...
- `11_install_pi_plugins.bash` reinstalls the Pi package list embedded from `pi_plugins.txt`; AAB-owned repositories follow their default branches, while third-party sources remain pinned.
